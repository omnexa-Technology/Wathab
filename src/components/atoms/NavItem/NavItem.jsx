...
const linkBaseClass =
  ' flex h-12 items-center hover:text-green-900 justify-center gap-2.5  py-0 rounded-[40px] font-semibold lg:font-bold lg:text-md md:px-2 md:text-sm lg:text-base  tracking-[var(--body-letter-spacing)] leading-[var(--body-line-height)] [font-style:var(--body-font-style)] ';
