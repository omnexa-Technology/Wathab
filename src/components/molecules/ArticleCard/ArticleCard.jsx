...
export function ArticleCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute bottom-0 left-0 right-0 px-8 py-12 bg-gradient-to-t from-[#141414]  backdrop-blur-md transition-all duration-300 ${isHovered ? 'min-h-[400px]' : 'min-h-[174px]'
          }`}
      >
