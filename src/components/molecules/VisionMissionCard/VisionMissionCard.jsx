...
export function VisionMissionCard({
  ...
  return (
    <Card
      className={`w-full bg-[#1a1c0f14] rounded-2xl border-[3px] border-[#86ba41] backdrop-blur-[6px] backdrop-brightness-100 backdrop-saturate-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.40),inset_1px_0_0_rgba(255,255,255,0.32),inset_0_-1px_4px_rgba(0,0,0,0.13),inset_-1px_0_4px_rgba(0,0,0,0.11)] ${className}`}
    >
