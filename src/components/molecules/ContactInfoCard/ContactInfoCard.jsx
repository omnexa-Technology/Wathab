...
export function ContactInfoCard({ icon, value, label, className = '' }) {
  return (
    <div
      className={`flex-1 min-w-0   rounded-2xl px-4 py-8 flex flex-col gap-0 items-center transition-all duration-300 hover:border-carousel-active hover:shadow-lg ${className}`}
    >
